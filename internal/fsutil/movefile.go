// Package fsutil provides small filesystem helpers shared by the pipeline
// and organiser packages (docs/ARCHITECTURE.md § 2.2, § 2.7).
package fsutil
...
// never silently clobbers a same-named file already at the destination.
